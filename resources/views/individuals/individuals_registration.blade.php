		  ...
		  <form id="multi-step-form">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
              <div class="text-start">
                ...
                <h2 class="mt-10 mb-5 text-brand-1" style="line-height: 1.6em;">Individuals Registration</h2>
              </div>
              <div class="login-register text-start mt-20" action="#">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                  <label class="form-label" for="input-1">Individuals Name *</label>
                  <input class="form-control" id="input-1" type="text" required="" name="fullname" placeholder="Steven Job">
                </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                  <label class="form-label" for="input-2">Individuals Email address *</label>
                  <input class="form-control" id="input-2" type="email" required="" name="emailaddress" placeholder="stevenjob@gmail.com">
                </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  <label class="form-label" for="input-3">Individuals Mobile Number *</label>
