                ...
                <form id="AddCountry"  onsubmit="return addCountry()">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="country_organiztions" id="country_organiztions" value="{{ $country_id }}">
                            <input type="hidden" name="sub_organiztions" id="sub_organiztions" value="{{ $subcountry_id }}">
                ...
                success: function(res) {
                    ...
                    if (res.status == '2') {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '{{ route("admin.suborganization_country", ["id" => $subcountry_id,"country_id"=>$country_id]) }}';
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
