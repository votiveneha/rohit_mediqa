                ...
                <table  class="table border table-striped table-bordered text-nowrap">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th>
                                <h6 class="fs-4 fw-semibold mb-0">Agency Name</h6>
                            </th>
                            <th>
                                <h6 class="fs-4 fw-semibold mb-0">Sector</h6>
                            </th>
                            <th>
                                <h6 class="fs-4 fw-semibold mb-0">Location Name</h6>
                            </th>
                            <th>
                        ...
                        @if ($job_list)
                            @foreach ($job_list as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <span class="mb-0 fw-normal fs-3">{{ $item->agency_name }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="">
                                    ...
                                    <td>
                                        <div class="">
                                            <span class="mb-0 fw-normal fs-3">{{ $item->location_name }}</span>
                                        </div>
                                    </td>
                                    <td>
