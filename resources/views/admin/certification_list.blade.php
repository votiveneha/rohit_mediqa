...
@section('content')
<x-card-component parentHeading="Language Skills Management" childHeading="Language Proficiency Certifications" parentUrl="{{route('admin.dashboard')}}" />
    <div class="card w-100  overflow-hidden ">
        <div class="card-header pb-0 p-4">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h5 class="card-title fw-semibold mb-0">Certification List</h5>
                </div>
                <div>
                ...
                <table  class="table border table-striped table-bordered text-nowrap">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th>
                                <h6 class="fs-4 fw-semibold mb-0">Proficiency Level</h6>
                            </th>
                            <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="">
                                            <span class="mb-0 fw-normal fs-3">
                                                ...
                                                @else
                                                @if ($item->test_id == 2)
                                                Other Language Proficiency Certifications
                                                @else
                                                @if ($item->test_id == 3) 
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            ...
                                            <a href="{{ route('admin.submembershipType', ['id' => $item->language_id]) }}"
                ...
                <form id="AddCountry" onsubmit="return addCountry()">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="form_type" value="certification_form">
                        ...
                        <div class="form-group">
                            <label for="language_field_type">Proficiency Level</label>
                            
                            <select id="test_id" class="form-control" name="test_id">
                                <option value="">select</option>
                                <option value="1">English Proficiency Tests</option>
                                <option value="2">Other Language Proficiency Certifications</option>
                                <option value="3">Specialized Language Skills</option>
                            </select>
                            <span id="proficiency_levelErr" class="text-danger"></span>
                        </div>
                    </div>
                ...
                <form id="EditMembership"  onsubmit="return editCountry()">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="edittest_id" class="form-control" name="test_id">
                                <option value="">select</option>
                                <option value="1">English Proficiency Tests</option>
                                <option value="2">Other Language Proficiency Certifications</option>
                                <option value="3">Specialized Language Skills</option>
                            </select>
                            <span id="editproficiency_levelErr" class="text-danger"></span>
                        </div>
                    </div>
                    <div class="modal-footer pt-0">
...
@section('js')
    ...
    <script type="text/javascript">
        function addCountry() {
            console.log("form_data",new FormData($('#AddCountry')[0]));
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.status == '2') {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '{{ route("admin.certification_list") }}';
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
                ...
                error: function(error) {
                    ...
                    if (error.responseJSON.errors) {
                        ...
                        if (error.responseJSON.errors) {
                            ...
                            $('#editproficiency_levelErr').text(error.responseJSON.errors.test_id[0]);
                        } else {
                            $('#languageNameErr').text('');
                            $('#editproficiency_levelErr').text('');
            ...
            $.ajax({
                ...
                error: function(error) {
                    ...
                    if (error.responseJSON.errors) {
                        console.log("errors",error.responseJSON.errors);
                        if (error.responseJSON.errors) {
                            $('#editlanguageNameErr').text(error.responseJSON.errors.language_name[0]);
                            $('#proficiency_levelErr').text(error.responseJSON.errors.test_id[0]);
                        } else {
                            $('#editlanguageNameErr').text('');
                            $('#proficiency_levelErr').text('');
