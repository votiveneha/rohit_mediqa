            ...
            <div class="table-responsive rounded-2 mb-4">
                <table  class="table border table-striped table-bordered text-nowrap">
                    ...
                    <tbody>
                        @php $i=1 @endphp
                        @if ($benefit_data)
                            @foreach ($benefit_data as $key => $item)
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td>
                                        <div class="">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            ...
                                            <a href="{{ route('admin.sub_benefits', ['id' => $item->benefits_id]) }}"
                ...
                <form id="AddCountry"  onsubmit="return addCountry()">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="subbenefit_id" value="0">
                ...
                success: function(res) {
                    ...
                    if (res.status == '2') {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '{{ route("admin.benefit_preferences") }}';
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
