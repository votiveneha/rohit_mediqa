                ...
                <form id="AddCountry"  onsubmit="return addCountry()">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="sub_language_id" value="{{ $language_id }}">
                            <input type="hidden" name="test_id" value="">
                            <input type="hidden" name="language_field_type" value="language_field">
                ...
                success: function(res) {
                    ...
                    if (res.status == '2') {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '{{ route("admin.sub_language_list", ["id" => $language_id]) }}';
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
